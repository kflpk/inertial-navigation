...
async def get_sensor_data():
    async with BleakClient(address) as client:
        while True:
            ...
            yield (acc_x, acc_y, acc_z, gyr_x, gyr_y, gyr_z, mag_x, mag_y, mag_z), asyncio.get_event_loop().time()
...
async def main():
    ...
    i = 0
    async for (acc_x, acc_y, acc_z, gyr_x, gyr_y, gyr_z, mag_x, mag_y, mag_z), t in get_sensor_data():
        print(t)
        if i == 0:
            time.sleep(0.15)
        i = 1
